...
public class TrackController {
    ...
    public ResponseEntity<String> deleteTrack(@RequestBody Track track)
    {
        ResponseEntity responseEntity;
        try {
            String answer=trackService.deleteTrack(track);
    ...
    @RequestMapping(value = "track/{trackName}/{trackId}", method = RequestMethod.GET)
    public ResponseEntity<List<Track>> getTrackByName(@PathVariable("trackName") String trackName, @PathVariable("trackId") int trackId) throws Exception
    {
